...
/* 卷帘的几何（节奏槽、时间轴接龙、月份刻度、cn/hash）统一住在 content/roll.mjs，
   生成器、Nitro 与浏览器共用一份，不再各写各的。这里先 import 进来自己用，
   再原样转出去——老调用点（tools/build.mjs、server/lib/articles.mjs…）不用改。 */
import {
  CN,
  cn,
  hash,
